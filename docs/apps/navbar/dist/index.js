System.register(['react', 'react-dom', 'react-router-dom', '@poc-mfe/globals'], function (exports) {
    'use strict';
    var React, ReactDOM, BrowserRouter, NavLink, globals;
    return {
        ...
        execute: function () {
            ...
            ***************************************************************************** */
            ...
            var css_248z = ".component-module_primaryNav__2by3Q {\n  height: 45px;\n  width: 100vw;\n  background-color: #35495e;\n  color: white;\n  display: flex;\n  justify-content: flex-end;\n}\n\n.component-module_primaryNav__2by3Q ul {\n  margin: 0;\n  padding: 0;\n  list-style-type: none;\n  display: flex;\n}\n\n.component-module_primaryNav__2by3Q li {\n  list-style: none;\n}\n\n.component-module_signedInText__BsucY,\n.component-module_navLink__2H4rY,\n.component-module_navLink__2H4rY:focus,\n.component-module_navLink__2H4rY:visited {\n  text-decoration: none;\n  color: white;\n  display: flex;\n  align-items: center;\n  padding: 0.8rem 1.6rem;\n}\n\n.component-module_navLink__2H4rY:hover {\n  background-color: #243241;\n}\n\n.component-module_activeNavLink__3UWdK {\n  background-color: #202d3a;\n}\n\n.component-module_searchBox__3jx98 {\n  padding: 8px;\n  line-height: 25px;\n}\n\n.component-module_signOutLink__OyuT2 {\n  cursor: pointer;\n}";
            var styles = {"primaryNav":"component-module_primaryNav__2by3Q","signedInText":"component-module_signedInText__BsucY","navLink":"component-module_navLink__2H4rY","activeNavLink":"component-module_activeNavLink__3UWdK","searchBox":"component-module_searchBox__3jx98","signOutLink":"component-module_signOutLink__OyuT2"};
            ...
            var Root = /** @class */ (function (_super) {
                ...
                function Root(props) {
                    ...
                    _this.state = { user: globals.state.auth.user() };
                ...
                Root.prototype.render = function () {
                    return (React.createElement(BrowserRouter, { basename: "/" },
                        React.createElement("nav", { className: styles.primaryNav },
                            React.createElement("ul", null,
                                this.state.user &&
                                    React.createElement("li", null,
                                        React.createElement("span", { className: styles.signedInText },
                                            "Signed in as ",
                                            this.state.user,
                                            "!")),
                                this.state.user &&
                                    React.createElement("li", null,
                                        React.createElement("a", { className: [styles.navLink, styles.signOutLink].join(' '), onClick: this.onSignOutClick }, "Sign Out")),
                                React.createElement("li", null,
                                    React.createElement("input", { type: "text", placeholder: "Enter search term", className: styles.searchBox, onKeyPress: this.onSearchKeypress })),
                                React.createElement("li", null,
                                    React.createElement(NavLink, { to: "/", className: styles.navLink, activeClassName: styles.activeNavLink }, "Home")),
                                React.createElement("li", null,
                                    React.createElement(NavLink, { to: "/account", className: styles.navLink, activeClassName: styles.activeNavLink }, "My Account"))))));
                };
                ...
                Root.prototype.onSignOutClick = function () {
                    window.dispatchEvent(globals.events.auth.SignOutEvent());
                };
                Root.prototype.onSearchKeypress = function (evt) {
                    var SearchTermEnteredEvent = globals.events.search.SearchTermEnteredEvent;
                    if (evt.key.toLowerCase() == "enter") {
                        var term = evt.currentTarget.value;
                        window.dispatchEvent(SearchTermEnteredEvent(term));
                ...
                Root.prototype.onSignOut = function () {
                    this.setState({
                        user: ''
                    });
                };
